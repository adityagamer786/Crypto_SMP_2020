...
for j in a:
    '''Because strings with spaces can also be a anagram. For example:
        String A: tom marvolo riddle  String B: i am lord voldemort
        are anagrams but their lengths aren't equal.'''
    if j != ' ': 
        pro1 *= char[ord(j)- 97 ]
